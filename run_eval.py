...
weights = "./trained_models/raw_resnet50/weights_best.pt"
...
print(f"Val Loss {val_loss:.4f} Top-1 Acc {acc1:.4f} Top-5 Acc {acc5:.4f}")
...
df.to_csv("blur_robustness_results_raw.csv", index=False)
